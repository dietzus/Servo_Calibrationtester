...
uint16_t readAngle() {
	...
	HAL_StatusTypeDef tempstatus = HAL_I2C_STATE_ERROR;
	while (tempstatus != HAL_I2C_STATE_READY) {
		//	HAL_I2C_Master_Receive(&hi2c1, 0x36, (uint8_t*)&tempbuffer, 2, HAL_MAX_DELAY);
		tempstatus = HAL_I2C_Mem_Read(&hi2c1, 0x36 < 1, 0x0C, I2C_MEMADD_SIZE_8BIT, (uint8_t*)&tempbuffer, 2, HAL_MAX_DELAY);
	}
